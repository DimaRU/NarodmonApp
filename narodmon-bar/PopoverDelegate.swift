...
extension AppDelegate: NSPopoverDelegate {
    ...
    func createContentViewController() {
        sensorsViewController = (NSStoryboard.main?.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier(rawValue: "PopupViewController")) as! PopupViewController)
